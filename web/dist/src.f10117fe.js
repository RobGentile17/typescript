  ...
  _createClass(View, [{
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        // eventKey will be click:button, or drag:div etc..
        var _eventKey$split = eventKey.split(":"),
            _eventKey$split2 = _slicedToArray(_eventKey$split, 2),
            eventName = _eventKey$split2[0],
            selector = _eventKey$split2[1]; // this basically says you will get back an eventName which will be the 'click' and then the selector which will be 'button'
    ...
    key: "render",
    value: function render() {
      this.parent.innerHTML = ""; //this will empty the parent element

      var templateElement = document.createElement("template");
      templateElement.innerHTML = this.template(); // this will rerender the template

      this.bindEvents(templateElement.content); //bind our events

      this.mapRegions(templateElement.content);
      this.onRender();
      this.parent.append(templateElement.content); // add it to the page
    }
  }]);
...
function () {
  function Eventing() {
    ...
    this.events = {}; // the key represents future event names like 'click', 'hover' ...

    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || [];
      handlers.push(callback);
      _this.events[eventName] = handlers; // this.events[eventName] might return undefined
...
function () {
  ...
  function Attributes(data) {
    ...
    this.get = function (key) {
      ...
      return _this.data[key]; // we are now returning either a name, age, or id from get
    };
  }

  Attributes.prototype.set = function (update) {
    Object.assign(this.data, update); // This is a built in method in javascript that will take all the properties from update and copy paste them over data
  };

  Attributes.prototype.getAll = function () {
    return this.data; // this will return all the data from UserProps
...
var Collection_1 = require("./Collection"); // the ? after the property allows these criteria to be optional
...
users.fetch(); // Reminder on how 'this' works in javascript
// const colors = {
//   color: "red",
//   printColor() {
...
//   },
// }
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../../.asdf/installs/nodejs/17.5.0/.npm/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.asdf/installs/nodejs/17.5.0/.npm/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
